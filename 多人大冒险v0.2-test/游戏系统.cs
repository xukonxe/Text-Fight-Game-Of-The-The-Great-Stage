...
namespace CMKZ.C02.多人大冒险01 {
    public static partial class 游戏系统 {
        ...
        public static string 版本=>"v0.01-Test";
        ...
        public static string 退出建筑(账号信息 K) {
        ...
        public static string 使用(账号信息 K, IUseable 目标家具) {
            ...
            //var 所在地图 = 世界.所有地图.Find(i => i.Contains(玩家));
            //if (玩家.所在建筑 != null) {
            //    var 可坐下的家具 = 玩家.所在建筑.坐标系.所有物体<IUseable>();
    ...
    public partial class 世界类 {
        ...
        public static 世界类 默认模版(string 名称) {
            var 新世界 = new 世界类(名称);
            var 主城商店 = new 主城商店();
            var A = new 商店柜台();
            主城商店.坐标系.Add(1, 1, A);
            新世界.主城.坐标系.Add(0, 0, 主城商店);

            var 聊天室= new 聊天室();
            新世界.主城.坐标系.Add(-5, -5, 聊天室);

            var 澡堂= new 澡堂();
            新世界.主城.坐标系.Add(5, 5, 澡堂);
            return 新世界;
        }
    }
    public partial class 世界类 {
